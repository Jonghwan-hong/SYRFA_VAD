...
def compute_auc(res, reverse, smoothing):
    ...
    for i in range(num_videos):
        ...
        # try:
        #     fpr, tpr, _ = metrics.roc_curve(gt[i], distance, pos_label=1)
        #     auc = metrics.auc(fpr, tpr)
        #     # if auc > 0.9:
        #     np.save('./qualitative result/ped2/scores/{}_scores'.format(i),distance)
        #     np.save('./qualitative result/ped2/labels/{}_labels'.format(i),gt[i])
        # except Exception:
        #     continue
